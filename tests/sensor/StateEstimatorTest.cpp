...
TEST(StateEstimatorTest, UpdateOdometryFusesMeasurements) {
  ...
  OdometerMeasurement meas{.rawPosition = 10.8,
                           .rawVelocity = 5.2,
                           .rawAcceleration = 0.0,
                           .timestamp = 1,
                           .isValid = true};
...
TEST(StateEstimatorTest, UpdateOdometryReducesUncertainty) {
  ...
  OdometerMeasurement meas{.rawPosition = estimator.position(),
                           .rawVelocity = 20.0,
                           .rawAcceleration = 0.0,
                           .timestamp = 5,
                           .isValid = true};
...
TEST(StateEstimatorTest, BaliseUpdateReducesPositionUncertaintySignificantly) {
  ...
  BaliseTransponder balise{
      .baliseId = 42, .trackId = 101, .exactPosition = 1060.0};
...
TEST(StateEstimatorTest, BaliseUpdateClearsOutlierCountAndDegradedState) {
  ...
  OdometerMeasurement invalid{.rawPosition = 0.0,
                              .rawVelocity = 0.0,
                              .rawAcceleration = 0.0,
                              .timestamp = 1,
                              .isValid = false};
  ...
  BaliseTransponder balise{
      .baliseId = 1, .trackId = 101, .exactPosition = 100.0};
...
TEST(StateEstimatorTest, RejectsStatisticalOutliers) {
  ...
  OdometerMeasurement spike{.rawPosition = 50000.0,
                            .rawVelocity = 20.0,
                            .rawAcceleration = 0.0,
                            .timestamp = 10,
                            .isValid = true};
...
TEST(StateEstimatorTest, DegradesAfterInvalidMeasurement) {
  ...
  OdometerMeasurement invalidMeas{.rawPosition = 0.0,
                                  .rawVelocity = 0.0,
                                  .rawAcceleration = 0.0,
                                  .timestamp = 1,
                                  .isValid = false};
...
TEST(StateEstimatorTest, DegradesAfterConsecutiveOutliers) {
  ...
  OdometerMeasurement spike{.rawPosition = 99999.0,
                            .rawVelocity = 10.0,
                            .rawAcceleration = 0.0,
                            .timestamp = 1,
                            .isValid = true};
