...
// 1D Kalman Filter State Estimator for Train Position, Velocity, and Acceleration.
//
// Fuses high-frequency noisy/drifting odometry with discrete absolute track balise fixes.
// Features outlier rejection gating and covariance uncertainty tracking.
