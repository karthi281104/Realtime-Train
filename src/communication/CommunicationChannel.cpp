...
bool CommunicationChannel::sendMessage(Message message,
...
bool CommunicationChannel::hasMessages(
    const std::uint32_t recipientId) const noexcept {
...
std::vector<Message> CommunicationChannel::receiveMessages(
